...
var SplitView = function (config, container) {
  var _this = this;
...
SplitView.prototype.initialiseHandlebars = function(){
  var _this = this;
...
SplitView.prototype.scrollToLetter = function(letter){
...
SplitView.prototype.listIndexTouchStart = function(e){
  e.preventDefault();
...
SplitView.prototype.listIndexTouchMove = function(e){
...
SplitView.prototype.listIndexTouchEnd = function(e){
  this.listIndexIsTouched = false;
};

SplitView.prototype.renderFilters = function(){
...
SplitView.prototype.renderFilterValues = function( filter, inOverlay ){
...
SplitView.prototype.switchMode = function(mode){
  /*
...
SplitView.prototype.isMode = function(mode){
  return this.directoryMode === mode;
};

SplitView.prototype.attachObservers = function(){
  var _this = this;
...
SplitView.prototype.activateSearch = function(){
...
SplitView.prototype.deactivateSearch = function(){
...
SplitView.prototype.resizeSearch = function(){
  var _this = this;
  setTimeout(function(){
...
SplitView.prototype.filterOverlayIsActive = function(){
  return this.filterOverlay instanceof Overlay;
};

SplitView.prototype.entryOverlayIsActive = function(){
  return this.entryOverlay instanceof Overlay;
};

SplitView.prototype.dataLinkClicked = function(e){
...
SplitView.prototype.openDataEntry = function(entryIndex, type, trackEvent){
  var _this = this;
  ...
  // @TODO: Remove the $entrytitle and title variables
...
SplitView.prototype.disableClicks = function () {
...
SplitView.prototype.addLoading = function () {
...
SplitView.prototype.removeLoading = function () {
...
SplitView.prototype.getEntryField = function( entryIndex, fieldIndex, type ){
  if ( typeof type === 'undefined' ) type = 'entry';
...
SplitView.prototype.renderLiveSearch = function( value ) {
...
SplitView.prototype.renderSearchResult = function( options, callback ){
...
SplitView.prototype.search = function( value ) {
  var path = ':root > :has(';
...
SplitView.prototype.filter = function( field, value ) {
...
SplitView.prototype.getFilterValues = function( field ) {
  var path = '."'+field+'"';
...
SplitView.prototype.parseQueryVars = function(){
...
SplitView.prototype.presetSearch = function( value ){
...
SplitView.prototype.presetFilter = function( field, value ){
  this.renderSearchResult( {
    type : 'filter',
    field : field,
    value : value
