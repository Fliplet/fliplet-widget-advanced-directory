...
var Agenda = function (config, container) {
  var _this = this;
...
Agenda.prototype.initialiseHandlebars = function(){
  var _this = this;
...
Agenda.prototype.verifyFields = function(fieldConfig){
...
Agenda.prototype.renderIndexList = function(){
...
Agenda.prototype.scrollToLetter = function(letter){
...
Agenda.prototype.listIndexTouchStart = function(e){
  e.preventDefault();
...
Agenda.prototype.listIndexTouchMove = function(e){
...
Agenda.prototype.listIndexTouchEnd = function(e){
  this.listIndexIsTouched = false;
};

Agenda.prototype.renderFilters = function(){
...
Agenda.prototype.renderFilterValues = function( filter, inOverlay ){
...
Agenda.prototype.switchMode = function(mode){
  /*
...
Agenda.prototype.isMode = function(mode){
  return this.directoryMode === mode;
};

Agenda.prototype.attachObservers = function(){
  var _this = this;
...
Agenda.prototype.activateSearch = function(){
...
Agenda.prototype.deactivateSearch = function(){
...
Agenda.prototype.resizeSearch = function(){
  var _this = this;
  setTimeout(function(){
...
Agenda.prototype.filterOverlayIsActive = function(){
  return this.filterOverlay instanceof Overlay;
};

Agenda.prototype.entryOverlayIsActive = function(){
  return this.entryOverlay instanceof Overlay;
};

Agenda.prototype.dataLinkClicked = function(e){
...
Agenda.prototype.openDataEntry = function(entryIndex, type, trackEvent){
  var _this = this;
...
Agenda.prototype.disableClicks = function () {
...
Agenda.prototype.addLoading = function () {
...
Agenda.prototype.removeLoading = function () {
...
Agenda.prototype.getEntryField = function( entryIndex, fieldIndex, type ){
  if ( typeof type === 'undefined' ) type = 'entry';
...
Agenda.prototype.renderLiveSearch = function( value ) {
...
Agenda.prototype.renderSearchResult = function( options, callback ){
...
Agenda.prototype.search = function( value ) {
  var path = ':root > :has(';
...
Agenda.prototype.filter = function( field, value ) {
...
Agenda.prototype.getFilterValues = function( field ) {
  var path = '."'+field+'"';
...
Agenda.prototype.parseQueryVars = function(){
...
Agenda.prototype.presetSearch = function( value ){
...
Agenda.prototype.presetFilter = function( field, value ){
  this.renderSearchResult( {
    type : 'filter',
    field : field,
    value : value
